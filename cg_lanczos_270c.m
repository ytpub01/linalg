...
for N=Nvalues
    ...
    [u1 flag relres iter rkperN]=mycg_lanczos(A1,b1,tol,maxiter);
    ...
    title(['Solution to the PDE at iteration k=' num2str(iter)...
        ' for N=' num2str(N)]);
    legend('exact','discretized','CG Lanczos','Location','SouthWest');
end
...
title('L2 norm of the CG Lanczos residual at each iteration');
