...
for N=Nvalues
    ...
    [u3 flag relres iter rkperN]=myminres1(A2,b2,tol,maxiter);
    ...
    title(['Solution to the PDE at iteration k=' num2str(iter)...
        ' for N=' num2str(N)]);
    legend('exact','discretized','MINRES1','Location','SouthWest');
end
...
title('L2 norm of the MINRES1 residual at each iteration');
