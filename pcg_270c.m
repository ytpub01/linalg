...
for N=Nvalues
    ...
    [u1 flag relres iter rkperN]=mypcg(A1,b1,tol,maxiter);
    ...
    title(['Solution to the PDE at iteration k=' num2str(iter)...
        ' for N=' num2str(N)]);
    legend('exact','discretized','PCG','Location','SouthWest');
end
...
title('L2 norm of the Pre-conditioned CG residual at each iteration');
